...
def data_prep(df, seq_len = 200):
    ...
    return matrix, target_acc, target_subj_acc,  mask, words
...
def data_gen():
    ...
    seq_length = 50
    mat, target , target_subj, mask, words = data_prep(data, seq_len = seq_length)
    ...
    return new_mat, new_target , new_target_subj, new_mask, new_word_df, label_dict
